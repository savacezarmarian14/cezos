...
__attribute__((__aligned__(PAGE_SIZE))) pde_t entry_pgdir[NUMBER_PDENTRIES] = {
	...
	// Map VA's [KERNEL_BASE_ADDRESS, KERNEL_BASE_ADDRESS+4MB) to PA's [0, 4MB)
	[KERNEL_BASE_ADDRESS>>PDXSHIFT]
		= ((virtaddr_t)entry_pgtable - KERNEL_BASE_ADDRESS) + PTE_P + PTE_W
};
